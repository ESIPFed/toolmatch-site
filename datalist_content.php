<span class="page_title">Data Collection List
	<span>Click on a data collection to see more info. Click the corresponding icon to add, delete, or find matching tools.</span>
</span></br>
<?php
...
try
{
	...
	foreach($data['results']['bindings'] as $result) {
		...
		<div class="instance_row">
			  ...
			  <div style="float:right;"><a href="http://toolmatch.esipfed.org/match.php?data=<?php echo $label; ?>"><img src="/images/magnifying_glass.png" alt="Find Matching Tools" title="Find Matching Tools" height="24px" width="24px" /></a></div>
