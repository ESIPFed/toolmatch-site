...
if( isset( $_GET["uri"] ) )
{
	...
	if (!empty($label)) {
		...
		echo '<div style="float:right;margin-right:20px;"><a href="http://toolmatch.esipfed.org/match.php?data=' . $label . '"><img src="/images/magnifying_glass.png" alt="Find Matching Tools" title="Find Matching Tools" height="24px" width="24px" /></a></div>
		<span style="float:right;margin-right:4px;"><a href="http://toolmatch.esipfed.org/delete.php?data=' . $label . '"><img src="/images/delete_icon.png" alt="Delete Data Collection" title="Delete Data Collection" height="24px" width="24px" onClick="return confirmDelete()" /></a></span>
		<span style="float:right;margin-right:4px;"><a href="http://toolmatch.esipfed.org/dataform.php?uri=' . $instance . '"><img src="/images/pencil-icon-128.png" alt="Edit Data Collection" title="Edit Data Collection" height="24px" width="24px" /></a></span></span>
		<br/><br/></br>';
	}
	...
	if (!empty($id)) {
		echo '<span style="font-weight:bold;">GCMD Entry ID: </span>' . $id . '<br/>';
	}
